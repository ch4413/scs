...
class FeaturesTests:
    ...
    def test_add_code(self):
        ...
        fa_expected = pd.DataFrame({'Number': {0: '1',
                                        1: '2',
                                        2: '3',
                                        3: '4',
                                        4: '5',
                                        ...
                                        8: '9',
                                        9: '10'},
                                'Alert': {0: 'SCS116: sto: timeout bin from lifter to car X:5 Y:4 S:2 [13.1] ',
                                        1: 'C05: C05PTT011_ external unit fault',
                                        2: 'C16: C1603STA253 253B12 occupancy sensor fault',
                                        3: 'C15: C1502RDC070 070B11 occupancy sensor fault',
                                        4: 'C23: C2301RDC176 176B14 occupancy sensor fault',
                                        5: 'SCS M20: single module 1 emergency stop unit     [24.0]',
                                        6: 'C14: C1404STA164 164D702 scanner / data tracking fault',
                                        7: 'C07: C0702STA074 074D702 scanner / data tracking fault',
                                        8: 'C08: C0803STA102 102D702 scanner / data tracking fault',
                                        9: 'C10: C1002STA081 081B15 clearance sensor fault'},
                                'Entry Time': {0: '2021-01-12 08:12:00',
                                                1: '2021-01-09 08:56:00',
                                                2: '2021-01-11 08:34:00',
                                                3: '2021-01-09 08:20:00',
                                                4: '2021-01-10 07:59:00',
                                                5: '2021-01-13 08:14:00',
                                                6: '2021-01-13 08:46:00',
                                                7: '2021-01-10 08:49:00',
                                                8: '2021-01-11 08:11:00',
                                                9: '2021-01-12 08:01:00'},
                                'PLC': {0: 'SCSM11',
                                        1: 'C05',
                                        2: 'C16',
                                        3: 'C15',
                                ...
                                'Fault ID': {0: '5105',
                                        ...
                                        8: '3504',
                                        9: '3419'},
                                'PLCN': {0: 0, 1: 5, 2: 16, 3: 15, 4: 23, 5: 0, 6: 14, 7: 7, 8: 8, 9: 10},
                                'Asset Code': {0: 'SCS116',
                                        1: 'C05PTT011',
                                        2: 'C1603STA253',
                                        3: 'C1502RDC070',
                                        ...
                                        8: 'C0803STA102',
                                        9: 'C1002STA081'}})
        fa_expected['PLCN'] = np.array([0,5,16,15,23,0,14,7,8,10], dtype=np.int32)

        assert fa_processed.equals(fa_expected)

    def test_add_tote_colour(self):
        fa = pd.DataFrame({'Number': {0: '1',
                                1: '2',
                                2: '3',
                                3: '4',
                                4: '5',
        ...
        fa_expected = pd.DataFrame({'Number': ['1','2','3','4','5',
                        ...
                        'Fault ID': ['5105','3611','3416','3416','3416',
                                '5416','3504','3504','3504','3419'],
                        'PLCN': np.array([0,5,16,15,23,0,14,7,8,10],dtype=np.int64),            
